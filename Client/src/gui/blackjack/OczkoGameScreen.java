...
public class OczkoGameScreen implements CustomScene {
    ...
    private static final String OCZEKIWANIE_NA_GRACZY = "Oczekiwanie na pozosta³ych graczy";
    private static final String OCZEKIWANIE_NA_TWOJA_TURE = "Oczekiwanie na twoj¹ turê";
    ...
    private Button getNextCardBtn = new Button("Daj kartê");
    ...
    private void onGetNextCardClicked() {
        ...
        try {
            ...
            addCard(new Card("C:\\Users\\Karolina\\Frytki\\Client\\img\\"+card+".png"));
        } catch(Exception ex) {}
