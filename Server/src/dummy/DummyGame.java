...
public class DummyGame extends UnicastRemoteObject implements Game
{
	...
	public DummyGame() throws RemoteException
	{
		Random k = new Random();
	...
	@Override
	public int join(GameClient gameClient) throws RemoteException {
		DummyGameClientInterface client = (DummyGameClientInterface) gameClient;
		if(clientCount >= 3)
		{
			client.notify("W pokoju jest juï¿½ 3 graczy");
			return 0;
		}
	...
	public int getCard(GameClient gameClient) throws RemoteException
	{
		DummyGameClientInterface dummyGame = (DummyGameClientInterface) gameClient;
		if(i > 52)
		{
